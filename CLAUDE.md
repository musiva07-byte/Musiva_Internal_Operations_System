...
Use the latest Moosiva Lux Wear logo as the primary visual reference.

Brand name shown in the logo: **Moosiva Lux Wear**

The updated brand identity is based on muted rose, dusty mauve, blush, warm ivory, champagne, and rose-gold tones.

The internal system must feel:
...
- Appropriate for a luxury ladies' fashion brand

The system must not look like:

- A warehouse application
- A generic blue admin dashboard
- A bright pink fashion website
- A dark technical control panel
- An overly decorative ecommerce storefront

### Brand Color Palette

```txt
Primary Brand Mauve: #9B5F68
Primary Hover: #854E58
Primary Soft: #E7D2D5

Deep Rose Brown: #5A353B
Dark Text: #2E2325
Muted Text: #746267

Warm Ivory Background: #FBF7F5
Soft Blush Background: #F3E7E5
Card Background: #FFFFFF
Secondary Card Background: #F8F1EF

Champagne Accent: #C79A87
Rose Gold Accent: #B77C70
Soft Metallic Accent: #D9B5A8

Border Color: #E7D8D5
Input Border: #D8C4C1
Sidebar Background: #F6ECEA
Sidebar Active Background: #E9D5D3
Sidebar Active Text: #6F4048
...
- Use warm ivory as the primary application background.
- Use white for main cards, tables, forms, dialogs, and content surfaces.
- Use primary mauve for primary buttons, active navigation, selected controls, key metrics, and restrained highlights.
- Use deep rose brown for headings and important labels.
- Use rose-gold and champagne only as subtle accent colors.
- Do not fill every card or section with mauve or rose.
- Do not use light rose or champagne for body text.
- Use semantic success, warning, danger, and info colors only for their intended statuses.
- Maintain strong contrast and readability throughout the system.
- Ensure the interface remains usable in bright office lighting and on standard laptop displays.

### Theme Tokens

Centralize the theme in `app/globals.css` and the Tailwind/shadcn theme configuration.

Use semantic CSS variables rather than scattering raw hexadecimal values across components.
...
:root {
  ...
  --brand-mauve: #9B5F68;
  --brand-mauve-dark: #854E58;
  --brand-rose-deep: #5A353B;
  --brand-blush: #F3E7E5;
  --brand-ivory: #FBF7F5;
  --brand-champagne: #C79A87;
  --brand-rose-gold: #B77C70;
}
```
...
- Use warm ivory or soft blush as the main background.
- Display the Moosiva logo prominently without distortion.
- Use muted mauve for the primary login button.
- Use subtle champagne or rose-gold borders and details.
- A faint radial blush treatment or subtle texture is acceptable.
- Avoid bright gradients and oversized decorative effects.
- Keep the login form highly readable.

#### Sidebar

- Use soft blush or warm ivory.
- Use deep rose-brown text.
- Use muted rose icons.
- Active navigation should use a soft mauve/blush background with darker mauve text.
- Keep clear hover, active, and focus states.
- Display the Moosiva logo at the top with correct proportions.

#### Header

- Use white or warm ivory.
- Add a subtle bottom border.
- Use mauve only for selected controls and active states.
- Keep profile and notification controls minimal.

#### Dashboard Cards

- Use white cards on the warm ivory application background.
- Use restrained blush, champagne, or rose-gold accents.
- Use primary mauve only for important values, icons, and highlights.
- Do not fill every card with brand color.
- Use semantic status colors for alerts and operational states.

#### Buttons

- Primary: muted mauve background with ivory text.
- Primary hover: darker mauve.
- Secondary: soft blush background with deep rose-brown text.
- Outline: muted rose border with dark readable text.
- Destructive: controlled muted red.
- Maintain visible keyboard focus indicators.

#### Tables

- Use white table surfaces.
- Use a soft blush table header.
- Use warm rose-gray borders.
- Use a very subtle mauve row hover.
- Keep dense operational data easy to scan.
- Use semantic status badges rather than decorative brand colors.

#### Forms

- Use white or ivory input backgrounds.
- Use soft rose-gray input borders.
- Use mauve focus rings.
- Use deep rose-brown labels.
- Use muted readable helper text.
- Do not sacrifice clarity for decorative styling.

#### Charts

Use a restrained coordinated chart palette:
...
- Use the latest Moosiva logo.
- Use muted mauve and deep rose-brown for headings and borders.
- Use rose-gold or champagne only as subtle accents.
- Keep invoices and labels clear in grayscale.
- Avoid large background fills that waste printer ink.
- Use thin, professional borders and high-contrast text.

### Typography

Use a clean, practical sans-serif such as Inter for the main application interface.

```css
font-family: Inter, system-ui, sans-serif;
```

For selected display headings or the login branding area, an elegant serif such as Cormorant Garamond or Playfair Display may be used.

Do not use script fonts for interface controls, tables, forms, navigation, or operational content.

The logo already carries the decorative identity, so the application typography must remain practical and readable.

### Accessibility

- Ensure text, controls, badges, and buttons meet accessible contrast requirements.
- Do not use light rose text on white.
- Do not use champagne as body text.
- Keep visible keyboard focus states.
- Ensure status is not communicated by color alone.
- Maintain readable font sizes and touch targets.

### Responsive Behavior

- Preserve usability on desktop, tablet, and mobile.
- Use a collapsible sidebar on smaller screens.
- Ensure tables, forms, dialogs, cards, and print actions remain usable on narrow layouts.
- Brand styling must never break responsive behavior.
...
Use muted mauve as the primary accent, with restrained rose-gold or champagne details.
