...
// Renders inside the existing root layout — must not include <html>/<body> (only
// app/global-error.tsx may do that, for failures in the root layout itself).
        ...
        {isPausedDb && (
          <div className="mt-4 rounded-md border border-[#E7D8D5] bg-[#FBF7F5] p-4 text-xs text-[#746267]">
            ...
            <p className="mt-1 leading-5">
              Supabase Free projects pause automatically after 7 days of inactivity. Log in to the
              Supabase dashboard and click <strong>Restore</strong> to unpause the project. The
              first query after restore may take 10–30 seconds.
            </p>
          </div>
        )}
