...
// Catches failures in the root layout itself — the one error boundary allowed to render its
// own <html>/<body> (it replaces the root layout entirely when triggered). app/error.tsx
// handles everything else and must NOT include <html>/<body> since it renders inside the
// still-working root layout.
export default function GlobalError({
  ...
  useEffect(() => {
    console.error("[Musiva] Unhandled root layout error:", error);
  }, [error]);
