  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-xl border border-musiva-border bg-white p-6 shadow-soft",
...
export function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      className={cn("text-lg font-semibold text-musiva-plum", className)}
      {...props}
    />
  );
}
